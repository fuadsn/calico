...
class OverlayView(ctx: Context, attrs: AttributeSet?) : View(ctx, attrs) {
    ...
    private val line = Paint().apply { color = 0xFF578E7E.toInt(); strokeWidth = 8f; style = Paint.Style.STROKE }
    private val dot = Paint().apply { color = 0xFFFFFFFF.toInt(); style = Paint.Style.FILL }
    private val hot = Paint().apply { color = 0xFFF5ECD5.toInt(); style = Paint.Style.FILL }
